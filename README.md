# Permitted Development Right pages
...
These pages are [updated nightly](https://github.com/digital-land/permitted-development-rights/actions) by the [GitHub Action](.github/workflows/run.yml).
